...
const Avatar = React.forwardRef((_a, ref) => {
    ...
    return (<AvatarPrimitive.Root ref={ref} className={cn("relative flex h-11 w-11 shrink-0 overflow-hidden rounded-full outline-none focus:ring-2 focus:ring-blue-500")} {...props}/>);
});
