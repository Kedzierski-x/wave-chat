...
interface ProfileDialogProps {
  isOpen: boolean;
  onClose: () => void;
  user: { name: string; email: string; avatar?: string; description?: string };
  onUpdateProfile: (avatar: File | null, description: string) => void;
}
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="relative group">
            <Avatar className="w-24 h-24">
              <AvatarImage
                src={previewAvatar || "/placeholder-avatar.svg"}
                alt={user.name}
              />
